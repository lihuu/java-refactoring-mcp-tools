...
abstract class AbstractAiRefactorAction(
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        run(project, editor, file)
    }

    /** Test seam. Synchronous. */
    fun run(project: Project, editor: Editor, file: PsiFile) {
        ...
        val target = handler.resolve(file, editor, editor.caretModel.offset)
            ?: return Notifier.error(project, handler.notApplicableMessage)
