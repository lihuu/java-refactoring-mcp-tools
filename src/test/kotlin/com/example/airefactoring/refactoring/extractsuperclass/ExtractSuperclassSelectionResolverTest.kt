...
class ExtractSuperclassSelectionResolverTest : LightJavaCodeInsightFixtureTestCase() {
    ...
    fun testResolvesSinglePublicMethodSamePackage() {
        ...
        assertTrue(result is ExtractSuperclassSelectionResolution.Success)
        val prep = (result as ExtractSuperclassSelectionResolution.Success).preparation
        assertEquals("ServiceSuper", prep.superclassName)
        assertEquals("example.ServiceSuper", prep.effectiveQualifiedNameSnapshot)
    }
    ...
    fun testResolvesTwoMembersExplicitPackage() {
        ...
        assertTrue(result is ExtractSuperclassSelectionResolution.Success)
        assertEquals("example.api.ServiceSuper", (result as ExtractSuperclassSelectionResolution.Success).preparation.effectiveQualifiedNameSnapshot)
    }
    ...
    fun testRejectsEmptyMembers() {
        ...
        assertTrue(result is ExtractSuperclassSelectionResolution.Failure)
        assertEquals("INVALID_RANGE", (result as ExtractSuperclassSelectionResolution.Failure).code.name)
    }
    ...
    fun testRejectsInvalidSuperclassName() {
        fixture()
        val result = resolver.resolve(
            project, "example/Service.java",
            lineOf("example/Service.java", "Service"), colOf("example/Service.java", "Service"),
